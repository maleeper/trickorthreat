...
document.addEventListener("DOMContentLoaded", function () {
        ...
        if (window.scrollY > 50) {
            ...
            if (typeof gsap !== 'undefined') {
                gsap.to('.nav-neon-line', {
                    boxShadow: '0 0 40px rgba(255, 69, 0, 0.8), 0 0 80px rgba(139, 0, 0, 0.6)',
                    duration: 0.3
                });
            }
        } else {
            ...
            if (typeof gsap !== 'undefined') {
                gsap.to('.nav-neon-line', {
                    boxShadow: '0 0 20px rgba(255, 69, 0, 0.6), 0 0 40px rgba(139, 0, 0, 0.4)',
                    duration: 0.3
                });
            }
        }
        ...
        logo.addEventListener('mouseenter', () => {
            ...
            for (let i = 0; i < 8; i++) {
                setTimeout(() => {
                    ...
                    createBloodParticle(rect.left + rect.width / 2, rect.top + rect.height / 2);
                }, i * 30);
            }
    ...
    document.querySelectorAll("button").forEach((button) => {
        button.addEventListener("click", function (event) {
            ...
            createBloodSplatter(rect.left + rect.width / 2, rect.top + rect.height / 2);
    ...
    window.addEventListener("load", () => {
        ...
        if (title) {
            ...
            tl.to(mainCard, { opacity: 1, y: 0, duration: 1, ease: "power2.out" }, "-=0.5");
            tl.to(badge, { opacity: 1, scale: 1, duration: 0.6, ease: "back.out(2)" }, "-=0.4");
